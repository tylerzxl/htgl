...
const PRINT_META = (process.env.PRINT_META && JSON.parse(process.env.PRINT_META)) || {
  ...
  printDownLoad: 'https://cdn.yonyoucloud.com/iprint/用友云打印助手.exe' // NOSONAR
};

const env = {
  HTTP_PREFIX: process.env.PREFIX || '',
  HTTP_SCRIPT_BASEURL: `http://${localPath}:${process.env.SCRIPT_PORT || 3004}/static`,
  HTTP_WEB_URL: process.env.WEB_URL || 'https://build.yyuap.com', // NOSONAR
  ...
  AUTH_WHITELIST: envConfig.AUTH_WHITELIST,
